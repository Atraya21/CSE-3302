...
public class RealEstateClass {
		...
		public RealEstateClass (String Property_Type,String Address,String City,int Zip,int Price,double Beds,double Baths,String Location,int Square_Feet,int Lot_Size,int Year_Built,int Days_On_Market,int Dollar_Per_Sq_Ft,int HOA_Per_Month) {
		...
		public void setHOA_Per_Montht(int HOA_Per_Month) {
			this.HOA_Per_Month=HOA_Per_Month;
			}
